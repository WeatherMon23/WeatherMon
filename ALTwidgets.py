...
class ALTTitle():
    ...
    def show_green_wifi(self):
        ...
        if self.wifi_icon is None:
            self.wifi_icon = ALTImage(self.line, x=241, y=5, src='/flash/icons/wifi_green.png')
        else:
    ...
    def show_red_wifi(self):
        ...
        """
        if self.wifi_icon is None:
            self.wifi_icon = ALTImage(self.line, x=241, y=5, src='/flash/icons/wifi_red.png')
        else:
    ...
    def show_green_cloud(self):
        ...
        if self.cloud_icon is None:
            self.cloud_icon = ALTImage(self.line, x=215, y=7, src='/flash/icons/cloud_green.png')
        else:
    ...
    def show_red_cloud(self):
        ...
        """
        if self.cloud_icon is None:
            self.cloud_icon = ALTImage(self.line, x=215, y=7, src='/flash/icons/cloud_red.png')
        else:
...
class ALTAlert(_DialogBase):
    ...
    def __init__(self, text, text_color=_DEFAULT_TEXT_COLOR, title = '',
                 title_color=_DEFAULT_TEXT_COLOR, color=0xFFFFFF):
        """
        Parameters
        ----------
        text : str
...
class ALTConfirmation(_DialogBase):
    ...
    def __init__(self, text, text_color=_DEFAULT_TEXT_COLOR, title = '',
                 title_color=_DEFAULT_TEXT_COLOR, color=0xFFFFFF, confirm_func = None):
        """
        Parameters
        ----------
        text : str
