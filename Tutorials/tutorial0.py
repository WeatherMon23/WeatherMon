...
temp_disc = Label(parent=weather_widget2, x=7, y=20, text='Cloudy', font=lv.font_montserrat_14, text_color=0xFFFFFF,                     width=116, long_mode=lv.label.LONG.BREAK, alignment=lv.label.ALIGN.LEFT)
