'''
Tutorial 7 example -- Alert message with sound
'''
import unit
from m5stack import *
...
def refresh_readings(src, event):
    if event == lv.EVENT.CLICKED:
        ...
        if temperature > 20:
            Alert("Temperature is above 20!", text_color=0x000, title='', title_color=0x00, color=0xFFFFFF,
                 sound_alert=True, close_func=None)
